<template>
    ...
    <div class="fm-table">
        <table class="table table-sm">
            <thead>
                <tr>
                    <th class="w-60" v-on:click="sortBy('name')">
            ...
            <tbody>
                ...
                <tr v-for="(directory, index) in directories"
                    ...
                    <td><b-button class="btn btn-primary"  @click="roleSelection(directory, $event)">...</b-button></td>
                ...
                <tr v-for="(file, index) in files"
                    ...
                    <td><b-button class="btn btn-primary"  @click="roleSelection(file, $event)">...</b-button></td>
...
import customFunctions from './mixins/customs';

export default {
  name: 'table-view',
  mixins: [translate, helper, managerHelper,customFunctions],
  props: {
